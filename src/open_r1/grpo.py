...
class GRPOScriptArguments(ScriptArguments):
    ...
    eval_dataset_name: str = field(
        default=None,
        metadata={
            "help": "Path to the evaluation dataset. If not provided, the training dataset will be used."
        },
    )
...
def main(script_args, training_args, model_args):
    ...
    if script_args.eval_dataset_name:
        dataset = load_dataset(script_args.eval_dataset_name.split(".")[-1], data_files={"train": script_args.dataset_name, "test": script_args.eval_dataset_name})
    else:
    ...
    def make_conversation(example):
        ...
        return {"prompt": prompt, "solution": example["output"]}
